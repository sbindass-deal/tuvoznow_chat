...
// const options = {
//   key: fs.readFileSync("/etc/letsencrypt/live/tuvoznow.com/privkey.pem", 'utf8'),
//   cert: fs.readFileSync("/etc/letsencrypt/live/tuvoznow.com/cert.pem", 'utf8'),
//   ca: fs.readFileSync("/etc/letsencrypt/live/tuvoznow.com/fullchain.pem", 'utf8')
// };
...
// var serverKey = 'AAAAAu4y_kw:APA91bHkc_ZoswLB1JOSEtsF8y006w0QmGd6bjfQvth3N6sU1loFpegOdI8lWQN6YWvgeA5SV3UmHR5puI2iq3FZ2vpFVC63PZr81wlAd47zcRxXYY9-QtosqWgmaxLwPTkiOSxfD9XR';
...
// app.get('/', (req, res) => {
//   res.send('Chat Server is running on port 3003')
// });
...
io.on('connection', function (socket) {
  ...
  socket.on('sendMessage', function (data) {
    ...
    /**
     * Create function for get conversation id outside connection method using callback
     * Refer link : https://stackoverflow.com/a/31875808/7493808
     */
